...
class TestBlockchain(unittest.TestCase):
    ...
    example_messages = 'tests/chain_data/messages.txt'
    ...
    def tearDown(self):
        try:
            ...
            os.remove(TestBlockchain.example_messages)
        except OSError:
            pass
...
def get_test_blockchain(ledger_file, message_file):
    return Blockchain(ledger_file, message_file)
